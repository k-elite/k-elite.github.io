...
MORE = [
    ...
    ("📸", "자세 분석", "관절 각도를 재서 횟수를 세고, 무너지는 곳을 짚습니다. 영상은 저장 안 함."),
    ("🧩", "내 루틴 짜기", "무엇을 강화할지 고르면 이유와 함께 추천하고, 고른 것만 담습니다."),
...
TICKER = [
    "몸 그림에서 짚기", "마음 케어 1388", "38개 종목 능력 훈련",
...
<section class="pad" id="screens" style="background:var(--ground-2);border-block:1px solid var(--rule)">
  <div class="wrap stack g32">
    ...
    <div class="cards c4">
      ...
      <div class="reveal" style="animation-delay:.24s"><div class="phone" data-par="0.03" style="width:100%"><img src="{S('44_bodymap_mind')}" alt="사람 모형에서 아픈 곳 짚기 — 가슴을 누르면 마음이 아파요까지"></div></div>
      <div class="reveal" style="animation-delay:.30s"><div class="phone" data-par="0.06" style="width:100%"><img src="{S('41_routine_training')}" alt="종목별 능력 훈련 — 관절 각도와 분량이 함께 적힌 운동 카드"></div></div>
    </div>
  </div>
</section>
